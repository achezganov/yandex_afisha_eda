...
@app.cell
def _(df):
    # На всякий случай сортируем по времени заказа
...
def _(mo):
    mo.md(r"""
    ### 3.2 Проверка репрезентативности, базовые метрики и поиск аномалий
    """)
    return


@app.cell
def _(df, user_profile):
...
def _(user_profile):
    ...
    return q_orders_99, q_tickets_99


@app.cell
def _(q_orders_99, q_tickets_99, user_profile):
    # Отфильтруем выбросы
